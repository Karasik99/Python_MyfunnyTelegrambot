...
def choose(message):
    if message.text == 'Пицца':
        ...
        list(map(markup.row, [itembtnpizzafrench,itembtnpizzastudent,
                              itembtnpizzacheese,itembtnpizzahawai,
                              itembtnpizzameet,itembtnpizzamashroom,
                              itembtnseason,itembtnback]))
        ...
        itembtnback = types.KeyboardButton('Назад')
        list(map(markup.row, [itembtnsushigrand,itembtnsushimafia,
                              itembtnsushigayshi,itembtnsushidance,
                              itembtnsushiv2022,itembtnsushifest,
                              itembtnsushifish,itembtnsushiistsaid,
                              itembtnlady,itembtnback]))
        ...
        itembtnback = types.KeyboardButton('Назад')
        list(map(markup.row, [itembtnwatercola,itembtnwatersprite,
                              itembtnwaterpepsi,itembtnkvas,
                              itembtnpulpy,itembtnrich,
                              itembtnfanta,itembtnback]))
...
def water_all(message):
    if message.text == 'Кока-Кола' in water_list:
        photo = open(os.getcwd() + '/telegram_bot_v7/photo/watercoca-cola.jpg', 'rb')
...
def sushi_all(message):
    if message.text == 'Гранд-Каньон':
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushigrand.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushimafia.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushigayshi.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushiDANCING QUEEN.jpg', 'rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushi2v2022.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushifest.jpg', 'rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushifish.jpg', 'rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/sushiistsaid2.jpg', 'rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzaseasons.jpg','rb')
...
def pizza_all(message):
    if message.text == 'Французкая':
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzafrench.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzastudent.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzacheese.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzahawai.jpg','rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzameet.jpg', 'rb')
        ...
        photo=open(os.getcwd() + '/telegram_bot_v7/photo/pizzamashrooms.jpg','rb')
...
def callworker(call):
    ...
    # elif call.data[0:10] == 'add_basket':
    #     list_products = []
    #     bot.send_message(call.message.chat.id, 'Уже добавил в твою корзину :)')
    #     call.message.append in list_products
    #
    #     global count_basket
    #     count_basket=+1
